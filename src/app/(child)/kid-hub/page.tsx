...
export default function KidHubPage() {
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '20px' }}>
          {tierSummary.length > 0 ? tierSummary.map(ts => (
            ...
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.3)', fontWeight: 600 }}>Start a session to track your mastery!</span>
          )}
        </div>
  ...
  function MoneyContent() {
    return (
      <div style={{ padding: '20px' }}>
        {/* Prominent stars/dollars display */}
        <div style={{
          background: 'rgba(255,255,255,0.04)',
          ...
          <div style={{ fontFamily: "'Nunito', sans-serif", fontSize: '36px', fontWeight: 900, color: '#f5a623', marginBottom: '4px' }}>
            ⭐ {totalStars}
          </div>
          {rateSet ? (
            <div style={{ fontFamily: "'Nunito', sans-serif", fontSize: '28px', fontWeight: 900, color: '#2ec4b6' }}>
              = ${starsToDollars(totalStars)} earned
            </div>
          ) : (
            <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.4)', fontWeight: 600, marginTop: '4px' }}>
              Ask your parent to set your reward rate!
            </div>
          )}
        </div>
    ...
    return (
      <div style={{ padding: '24px 20px' }}>
          ...
          {avatarUrl ? (
            ...
            <img
              ...
              style={{
                ...
                margin: '0 auto',
                display: 'block',
                boxShadow: '0 0 0 5px rgba(46,196,182,0.15)',
              }}
            />
          ) : (
            <div style={{
        ...
        <h1 style={{
          ...
          Hey {displayName(childName)}{yearLevel <= 6 ? '! 👋' : '.'}
        </h1>
        ...
        <p style={{
          ...
          {rateSet
            ? `⭐ ${totalStars} = $${starsToDollars(totalStars)} earned`
            : `⭐ ${totalStars} stars`}
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '8px' }}>
          ...
          >
            ...
            <span style={{ fontFamily: "'Nunito', sans-serif", fontSize: '13px', fontWeight: 800 }}>Homework help</span>
          </button>
  ...
  return (
    <div style={{
      ...
      {/* Spacer for fixed ChildHeader (52px) */}
      <div style={{ height: '52px', flexShrink: 0 }} />

      {/* Main content area */}
      <div className="kid-hub-content" style={{ flex: 1, overflowY: 'auto', paddingBottom: '80px', maxWidth: '500px', width: '100%', margin: '0 auto', alignSelf: 'stretch' }}>
      ...
      <div style={{
        ...
        {([
          ...
          <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{
            ...
            <span style={{ fontSize: '10px', fontWeight: 700, color: activeTab === tab.id ? '#2ec4b6' : 'rgba(255,255,255,0.35)', fontFamily: "'Nunito', sans-serif" }}>{tab.label}</span>
          </button>
        ))}
      </div>
